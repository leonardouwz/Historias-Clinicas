...
('Dr. Julio Hugo Vega Zuñiga', '22556677', 1, 'CMP12345', (SELECT TOP 1 id_contacto FROM InformacionContacto WHERE telefono_principal = '945678901')),
...
(4, 'Dermatitis atópica severa', 'Aplicar capa fina', '2 veces al día', '4 semanas', 'Tópica'),
(4, 'Psoriasis en placas', 'Aplicar sobre lesiones', '1 vez al día', '6 semanas', 'Tópica'),
(5, 'Tiña corporis', 'Aplicar sobre área afectada', '2 veces al día', '4 semanas', 'Tópica'),
(5, 'Candidiasis cutánea', 'Aplicar generosamente', '2 veces al día', '2 semanas', 'Tópica'),
(6, 'Acné comedonal', 'Aplicar por las noches', '1 vez al día', '12 semanas', 'Tópica'),
(6, 'Fotoenvejecimiento', 'Aplicar gradualmente', '3 veces por semana', '24 semanas', 'Tópica'),

-- Medicamentos Cardiológicos
(7, 'Hipertensión arterial', '10-20mg', '1 vez al día', 'Crónico', 'Oral'),
(7, 'Insuficiencia cardíaca', '2.5-5mg inicial', '2 veces al día', 'Crónico', 'Oral'),
(8, 'Hipertensión arterial', '50-100mg', '1-2 veces al día', 'Crónico', 'Oral'),
(8, 'Angina de pecho', '50mg', '2 veces al día', 'Crónico', 'Oral'),
(9, 'Dislipidemia', '10-20mg', '1 vez al día', 'Crónico', 'Oral'),
(9, 'Prevención cardiovascular', '20mg', '1 vez al día', 'Crónico', 'Oral'),

-- Medicamentos Neurológicos
(10, 'Epilepsia focal', '500mg inicial', '2 veces al día', 'Crónico', 'Oral'),
(10, 'Epilepsia generalizada', '1000mg', '2 veces al día', 'Crónico', 'Oral'),
(11, 'Dolor neuropático', '300mg inicial', '3 veces al día', 'Crónico', 'Oral'),
(11, 'Fibromialgia', '300-600mg', '3 veces al día', 'Crónico', 'Oral'),

-- Medicamentos Traumatológicos
(12, 'Dolor agudo musculoesquelético', '50mg', '3 veces al día', '7 días', 'Oral'),
(12, 'Artritis reumatoide', '50mg', '2-3 veces al día', '4 semanas', 'Oral'),
(13, 'Dolor leve a moderado', '400mg', '3 veces al día', '10 días', 'Oral'),
(13, 'Inflamación articular', '600mg', '3 veces al día', '2 semanas', 'Oral'),

-- Medicamentos Ginecológicos
(14, 'Anticoncepción hormonal', '1 tableta', '1 vez al día', 'Crónico', 'Oral'),
(15, 'Candidiasis vaginal', '1 óvulo', 'Dosis única', '1 día', 'Vaginal'),
(15, 'Vaginitis por cándida', '1 óvulo', '1 vez al día', '3 días', 'Vaginal'),

-- Medicamentos Oftalmológicos
(16, 'Glaucoma de ángulo abierto', '1 gota', '2 veces al día', 'Crónico', 'Oftálmica'),
(17, 'Uveítis anterior', '1-2 gotas', '4 veces al día', '2 semanas', 'Oftálmica'),
(17, 'Conjuntivitis alérgica', '1 gota', '3 veces al día', '1 semana', 'Oftálmica'),

-- Medicamentos Psiquiátricos
(18, 'Depresión mayor', '50mg inicial', '1 vez al día', 'Crónico', 'Oral'),
(18, 'Trastorno de ansiedad generalizada', '25mg inicial', '1 vez al día', 'Crónico', 'Oral'),
(19, 'Trastorno de ansiedad', '0.5-1mg', '2-3 veces al día', '4 semanas', 'Oral'),
(19, 'Insomnio transitorio', '1-2mg', '1 vez antes de dormir', '2 semanas', 'Oral'),

-- Medicamentos Endocrinos
(20, 'Diabetes mellitus tipo 2', '500-850mg', '2-3 veces al día', 'Crónico', 'Oral'),
(20, 'Síndrome de ovario poliquístico', '500mg', '2 veces al día', 'Crónico', 'Oral'),
(21, 'Hipotiroidismo', '25-50mcg inicial', '1 vez al día', 'Crónico', 'Oral'),
(21, 'Mixedema', '100-200mcg', '1 vez al día', 'Crónico', 'Oral'),

-- Medicamentos Gastroenterológicos
(22, 'Úlcera duodenal', '20mg', '1 vez al día', '4-8 semanas', 'Oral'),
(22, 'Reflujo gastroesofágico', '20-40mg', '1 vez al día', 'Crónico', 'Oral'),
(23, 'Diarrea aguda', '4mg inicial, luego 2mg', 'Después de cada deposición', '48 horas', 'Oral'),
(23, 'Síndrome del intestino irritable', '2mg', '2-4 veces al día', '2 semanas', 'Oral'),

-- Medicamentos Neumológicos
(24, 'Asma bronquial', '100-200mcg', '4-6 veces al día', 'Según necesidad', 'Inhalada'),
(24, 'Broncoespasmo agudo', '200mcg', 'Cada 4-6 horas', 'Según necesidad', 'Inhalada'),
(25, 'Asma persistente', '200-400mcg', '2 veces al día', 'Crónico', 'Inhalada'),
(25, 'EPOC estable', '400mcg', '2 veces al día', 'Crónico', 'Inhalada'),

-- Medicamentos Pediátricos
(26, 'Fiebre en niños', '10-15mg/kg', 'Cada 6-8 horas', '3 días', 'Oral'),
(26, 'Dolor leve en pediatría', '10mg/kg', 'Cada 6 horas', '5 días', 'Oral'),
(27, 'Infecciones respiratorias en niños', '20-40mg/kg/día', 'Cada 8 horas', '7-10 días', 'Oral'),
(27, 'Otitis media aguda', '80-90mg/kg/día', 'Cada 12 horas', '10 días', 'Oral');
GO

PRINT 'Indicaciones de medicamentos insertadas: ' + CAST(@@ROWCOUNT AS VARCHAR);

-- =====================================================
-- PASO 8: INSERTAR ESPECIALIDADES MÉDICAS BÁSICAS
-- =====================================================

PRINT '';
PRINT '8. INSERTANDO ESPECIALIDADES MÉDICAS BÁSICAS...';
PRINT '-----------------------------------------------';

INSERT INTO EspecialidadesMedicas (nombre_especialidad, descripcion) VALUES
('Dermatología', 'Especialidad médica que estudia la estructura y función de la piel'),
('Medicina General', 'Atención médica integral y continua del individuo y la familia'),
('Pediatría', 'Especialidad médica que estudia al niño y sus enfermedades');
GO

PRINT 'Especialidades médicas básicas insertadas: ' + CAST(@@ROWCOUNT AS VARCHAR);

-- =====================================================
-- PASO 9: HISTORIAS CLÍNICAS COMPLETAS
-- =====================================================

PRINT '';
PRINT '9. INSERTANDO HISTORIAS CLÍNICAS...';
PRINT '-----------------------------------';
...
-- =====================================================
-- PASO 10: CONSULTAS MÉDICAS VARIADAS
-- =====================================================

PRINT '';
PRINT '10. INSERTANDO CONSULTAS MÉDICAS...';
PRINT '-----------------------------------';
...
(1, 9, '2024-01-15 09:30:00', 'Hipertensión Arterial', 
...
(4, 4, '2024-02-12 09:00:00', 'Gastritis Crónica',
...
(12, 12, '2024-02-15 16:20:00', 'Lumbalgia Mecánica',
...
-- =====================================================  
-- PASO 11: RECETAS MÉDICAS COMPLETAS
-- =====================================================

PRINT '';
PRINT '11. INSERTANDO RECETAS MÉDICAS...';
PRINT '---------------------------------';
...
-- Receta 2: Epilepsia  
(2, 10, '60 días', 120, 'No suspender bruscamente, tomar con alimentos', '2024-01-20', '2024-03-20'),

-- Receta 3: Dermatitis
(3, 4, '14 días', 2, 'Aplicar capa fina, no usar en cara, suspender gradualmente', '2024-02-01', '2024-02-15'),

-- Receta 4: Endometriosis
(4, 12, '15 días', 45, 'Tomar con alimentos, suspender si sangrado gastrointestinal', '2024-02-05', '2024-02-20'),

-- Receta 5: Bronquiolitis
(5, 24, '7 días', 1, 'Nebulizar cada 6 horas, agitar antes de usar', '2024-02-10', '2024-02-17'),
(5, 26, '3 días', 1, 'Solo si fiebre mayor a 38°C, máximo cada 6 horas', '2024-02-10', '2024-02-13'),

-- Receta 6: Gastritis
(6, 22, '30 días', 30, 'Tomar 30 minutos antes del desayuno', '2024-02-12', '2024-03-14'),

-- Receta 7: Lumbalgia
(7, 12, '7 días', 21, 'Tomar después de comidas, suspender si dolor epigástrico', '2024-02-15', '2024-02-22'),

-- Receta 8: Glaucoma
(8, 16, '90 días', 3, 'Instalar 1 gota cada 12 horas, presionar saco lagrimal', '2024-02-18', '2024-05-18'),

-- Receta 9: Ansiedad
(9, 18, '30 días', 30, 'Tomar con alimentos, no suspender bruscamente', '2024-02-20', '2024-03-22'),

-- Receta 10: Diabetes
(10, 20, '30 días', 60, 'Tomar con primera comida del día y cena', '2024-02-22', '2024-03-24');
GO
